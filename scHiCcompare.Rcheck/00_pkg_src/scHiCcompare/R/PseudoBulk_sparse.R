...
#'
#' @param scHiC.table A data frame containing interaction frequencies across cells that are created by the \code{scHiC_table()} function.
...
#'         returns a data frame containing a pseudo-bulk matrix in the sparse upper triangular Hi-C matrix format with five columns:
