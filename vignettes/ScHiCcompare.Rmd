...
<<<<<<< HEAD
`plot_HiCmatrix_heatmap()` produces a heatmap visualization for HiC and scHiC matrices. It requires an input as a sparse matrix [Input](#input) with 3 column of. More information can be found in its help document and the example below.
=======
