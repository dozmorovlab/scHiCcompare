...
```{r, echo = T}
DT::datatable(head(imp_ODC_table), options = list(pageLength = 6, dom = 'tip'),
              rownames = FALSE, width = 700)

DT::datatable(head(norm_result), options = list(pageLength = 6, dom = 'tip'),
              rownames = FALSE, width = 700)
```
