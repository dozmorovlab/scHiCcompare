...
If you have full Hi-C contact matrices, you can convert them to sparse upper triangular format using the `full2sparse()` function of `HiCcomprae` [??? Refer to all packages in BioC style, BiocStyle::Biocpkg()] packge, then reformat the column to achieve the requirement input format.
