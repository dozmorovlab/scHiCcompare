...
- `pool.style` - Character string specifying the pooling style for `imputation`. Options are 'none, 'progressive' or 'Fibonacci'. Default is 'progressive'.
...
result = ScHiCcompare(file.path.1 = 'ODCs_example', file.path.2 = 'MGs_example',
             ...
             normalization = 'Loess',
             differential.detect = 'MD.cluster',
             pool.style = 'none', fprControl.logfc = 0.8, 
