...
```{r}
data(MG_1)
names(MG_1) <- c('chr1' , 'start1', 'chr2', 'start2', 'IF')
DT::datatable(head(MG_1))
```
...
scHiC.table_ODC = scHiC_table(file.path = "ODCs_example", cell.type = 'ODC', position.dataset =  1:50, type='txt', select.chromosome = 'chr22')

scHiC.table_MG = scHiC_table(file.path = "MGs_example", cell.type = 'MG', position.dataset =  1:50, type='txt', select.chromosome = 'chr22')
```
