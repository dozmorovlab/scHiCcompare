...
```{r}
ODC.table = scHiC.table(file_path = "/Users/mynguyen/Documents/GitHub/scHiCcompare/Example/Data/ODC", position_dataset = 1:50, cell_type = 'ODC', type='txt', select_chromosome = 'chr22')

MG.table = scHiC.table(file_path = "/Users/mynguyen/Documents/GitHub/scHiCcompare/Example/Data/MG", position_dataset = 1:50, cell_type = 'MG', type='txt', select_chromosome = 'chr22')
